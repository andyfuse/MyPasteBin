    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ttl_option', models.CharField(default=None, max_length=10, choices=[(None, b'----'), (b'minutes=10', b'10 minutes'), (b'hours=1', b'1 hour'), (b'days=1', b'1 day'), (b'days=7', b'1 week'), (b'days=30', b'1 month')])),
            ],
        ),
        migrations.CreateModel(
            name='Syntax',
